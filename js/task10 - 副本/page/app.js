// JavaScript Document
var app = angular.module('angularJS',['ui.router','oc.lazyLoad']);//,'tm.pagination'
var aMes;
var mesLength;
var aSelect;
var fileReady = false;
...
/* var user = getCookie('testname'); */
/* $(window).on('load',function(){
	for(var i=0; i<3; i++){
		$('.pageLink').eq(i).attr('href','#/page'+(i+1)+'/')
	}
}) */
...
app.config(function ($stateProvider, $urlRouterProvider) {
     $urlRouterProvider.when("", "/:user/page1");
     $stateProvider
        .state("page1", {
            url: "/:user/page1",
